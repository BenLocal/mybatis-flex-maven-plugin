...
public class EntityGenerator implements IPoetGenerator {
    ...
    private JavaFile createJavaFileWithBase(Table table, GlobalConfig globalConfig) {
        ...
        entityTypeSpecBuilder
                .addJavadoc("<p>\n")
                .addJavadoc("Generated by MyBatis Code Generator.\n")
                .addJavadoc("</p>\n")
                .addJavadoc("@author MyBatis Code Generator\n");

        return JavaFileUtils
                .createJavaFile(getBasePackageName(globalConfig, false), entityTypeSpecBuilder.build());
    }
    ...
    private JavaFile createJavaFile(Table table, GlobalConfig globalConfig, boolean base) {
        ...
        for (Column column : table.getColumns()) {
            ...
            boolean columnNullable = columnNullable(column);
            ...
            if (column.isPrimaryKey()) {
                field.addAnnotation(AnnotationSpec.builder(com.mybatisflex.annotation.Id.class)
                        .addMember("keyType", "$T.Auto", KeyType.class)
                        .build());
            }
            ...
            field.addAnnotation(AnnotationSpec.builder(com.mybatisflex.annotation.Column.class)
                    ...
                    .build());
            if (columnNullable) {
                field.addAnnotation(AnnotationSpec.builder(Nullable.class).build());
            }
            ...
            if (columnNullable) {
                ...
                getterMethod.addAnnotation(AnnotationSpec.builder(Nonnull.class).build());
            }
            ...
            setterMethod.addJavadoc("@param $N the new value for the property\n", columnName);
        ...
        return JavaFileUtils.createJavaFile(getBasePackageName(globalConfig, base), entityTypeSpecBuilder.build());
    }
    ...
    private boolean columnNullable(Column column) {
        return column.getNullable() != null && column.getNullable() == 1;
    }
}
